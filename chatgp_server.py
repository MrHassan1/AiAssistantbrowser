...
print("Initializing agent handler (OpenAI)...")
agent_handler = AgentHandler(provider='openai')
print("Agent handler (OpenAI) initialized.")

@app.route('/')
def index():
    return "OpenAI Agent server is running!"
