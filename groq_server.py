...
print("Initializing agent handler...")
agent_handler = AgentHandler(provider='groq')
...
# The browser is no longer managed by agent_handler, so no need for shutdown_server.
# The browser is managed by the extension's JavaScript.
